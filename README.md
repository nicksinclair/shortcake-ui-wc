...
Shortcake is the design system for [Bakepedia](https://github.com/nicksinclair/bakepedia-client).

This version of Shortcake uses [web components](https://www.webcomponents.org/) that are built using [Stencil.js](https://stenciljs.com/).
